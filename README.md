...
Aplikasi Pertambahan Dua Angka adalah sebuah program sederhana berbasis Java yang memungkinkan pengguna untuk memasukkan dua angka, menjumlahkannya, dan menampilkan hasilnya. Aplikasi ini dikembangkan dengan menggunakan NetBeans dan JFrame sebagai GUI (Graphical User Interface). Berikut adalah deskripsi lengkap mengenai aplikasi ini:

1. Fitur Utama
Input Dua Angka: Pengguna dapat memasukkan dua angka dalam dua kolom input yang disediakan (JTextField).
Operasi Penjumlahan: Saat pengguna menekan tombol Tambah, aplikasi akan menjumlahkan kedua angka yang diinput dan menampilkan hasilnya di kolom hasil.
Tombol Hapus: Tombol Hapus akan menghapus semua input dari kolom angka pertama, angka kedua, dan hasil. Setelah dihapus, fokus akan diarahkan kembali ke kolom input angka pertama.
Tombol Keluar: Tombol Keluar memungkinkan pengguna untuk menutup atau keluar dari aplikasi.
...
- Muhammad Rizki Insani 2210010075
